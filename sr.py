...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/Dehaze.json', help='JSON file for configuration')
    #parser.add_argument('-c', '--config', type=str, default='/home/yuhu/code/Image_Dehazing/config/Dehaze.json', help='JSON file for configuration')
    ...
    parser.add_argument('-log_wandb_ckpt',default = "True",  action='store_true')
    parser.add_argument('-log_eval',default = "True",  action='store_true')
    ...
    for phase, dataset_opt in opt['datasets'].items():
        print("==========================")
        print("Giá trị của phase là:", phase)
        print("===========================")
